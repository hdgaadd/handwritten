...
//Node<K,V> implements Map.Entry<K,V>,Node就是一个Entry,把Entry换了一个名
...
public class MyHashMap<K,V>{
    ...
    public void putVal(int hash,K key,V value){
        Node<K,V>[] tab;Node<K,V> p;int n,i;//p是该下标的第一个元素
